...
print(f"{awesome_people[0]}, {awesome_people[1]}, {awesome_people[2]}, you're invited to my imaginary party, yay! [{len(awesome_people)}]")
...
print(f"{awesome_people[0]}, {awesome_people[1]}, {awesome_people[2]}, {awesome_people[3]}, {awesome_people[4]}, {awesome_people[5]}, you're invited to my imaginary party, yay! [{len(awesome_people)}]\n"
    ...
    f"{awesome_people[0]} and {awesome_people[1]}, you're still invited, yay! [{len(awesome_people)}]")

del awesome_people[0], awesome_people[0]

print(f"{awesome_people} still here? Good. [{len(awesome_people)}]")
